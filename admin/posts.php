		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="panel panel-default">
                 ...
                 <h3 class="panel-title" style="color:  white;"> Rooms Listing</h3>
				  </div>
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-2" align="right">
								<a href="compose_post.php" style="background-color: green;color: white;" class="btn btn-default btn-xs">Add New</a>				
							</div>
						</div>
					</div>
