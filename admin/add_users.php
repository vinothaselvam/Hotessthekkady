      ...
      <div class="col-md-9">
        <div class="panel panel-default">
           <div class="panel-heading" style="background-color:  darkgreen;";>
					<h3 class="panel-title" style="color:  white;">Add / Edit User</h3>
				  </div>
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo $userDetails['first_name']; ?>" placeholder="First name.." required>							
						</div>
						...
						<div class="form-group">
							...
							<input type="email" class="form-control" id="email" name="email" value="<?php echo $userDetails['email']; ?>" placeholder="email.." required>							
						</div>					
						<?php 
						if(!$user->id) {	
						?>
						<div class="form-group">
							...
							<input type="password" class="form-control" id="password" name="password" value="<?php echo $userDetails['password']; ?>" placeholder="password.." required>							
						</div>	
						<?php } ?>						
						...
						<div class="form-group">
							...
							<label class="radio-inline">
								<input type="radio" name="user_type" checked="" id="admin" value="1" <?php if($userDetails['type'] == 1) { echo "checked";} ?>>Administrator
							</label>
							<label class="radio-inline">
						...
						<div class="form-group">
							...
							<label class="radio-inline">
								<input type="radio" name="user_status" id="active" checked="" value="0" <?php if(!$userDetails['deleted']) { echo "checked";} ?> >Active
							</label>
							<label class="radio-inline">
