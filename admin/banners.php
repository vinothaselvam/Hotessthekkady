		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					...
					<h3 class="panel-title" style="color:  white;">Banner Listing</h3>
				  </div>
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-2" align="right">
								<a href="compose_banner.php"
								 style="background-color: cornflowerblue;" class="btn btn-default btn-xs">Add Banners</a>				
							</div>
						</div>
					</div>
