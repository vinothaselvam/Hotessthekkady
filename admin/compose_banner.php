...
<section id="main">
			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-heading" style="background-color:  #095f59;">
					<h3 class="panel-title" style="color:  white;">Add New Banner</h3>
				  </div>
				  <div class="panel-body">
					...
					<form method="post" id="bannerForm" enctype="multipart/form-data">							
						...
						<div class="form-group">
							<label for="title" class="control-label"> Banner Title</label>
 ...
 -->
							...
							<div class="form-group">
							<label for="title" class="control-label">Upload Banner Picture</label>
						...
						<input type="submit" name="saveBanner" id="saveBanner" class="btn btn-info" value="Save" />											
					</form>				
				  </div>
				</div>
			</div>
